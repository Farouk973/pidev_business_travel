...
public class EmployeeController {
    ...
    @ResponseBody
    public Employee ajouterEtAffecterMedecinToClinique(@RequestBody Employee employee ,@PathVariable("identreprise") Long identreprise){
	...
	public Employee updateEntreprise(@PathVariable Long id , @RequestBody Employee employee)
	{
	 ...
	 @org.springframework.web.bind.annotation.DeleteMapping("/removeEntreprise/{employeeId}")
	   public void removeClient(@PathVariable("employeeId") Long employeeId){
		 serviceemployee.deleteEmployee(employeeId);
	   }

		@org.springframework.web.bind.annotation.GetMapping("/retrieveEntreprise/{EmployeeId}")
